...
<head>
						...
						<div class="col-lg-5 col-md-6 d-flex flex-column align-items-center justify-content-center">
							...
							<div class="card mb-3">
								<div class="card-body">
									...
									<form class="row g-3 needs-validation" method="post" action="dangnhapcontroller" id="form">
										<div class="col-12">
  ...
  <script>
	// thuc thi khi trang web đã tải xong
	window.onload = function() {
		...
		form.addEventListener("submit",	function(event) {
			// ngan user gui bieu mau nhu thong thuong để đảm bảo xử lý captcha mới gửi 
